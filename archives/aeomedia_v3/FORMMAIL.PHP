...
// referers.. Change domains/ips that you will allow forms to 
// reside on. 
$referers = array ('mydomain.com','hostrack.com','www.hostrack.com');
...
function build_body($title, $bgcolor, $text_color, $link_color, $vlink_color, $alink_color, $style_sheet) { 
   ...
   echo "<body bgcolor=\"$bgcolor\" text=\"$text_color\" link=\"$link_color\" vlink=\"$vlink_color\" alink=\"$alink_color\"
$background>\n\n"; 
} 
...
if (($ZIP_CODE) || ($zip_code)) { 
   ...
   if ($ZIP_CODE) 
      $zip_code = trim($ZIP_CODE); 
   if (!ereg("(^[0-9]{5})-([0-9]{4}$)", trim($zip_code)) && (!ereg("^[a-zA-Z][0-9][a-zA-Z][[:space:]][0-9][a-zA-Z][0-9]$",
...
if ($redirect) { 
   ...
   echo "<br><br>\n"; 
   echo "<small>This form is powered by <a href=\"http://www.lumbroso.com/scripts/\">Jack's Formmail.php
$version!</a></small>\n\n"; 
   exit; 
} 
